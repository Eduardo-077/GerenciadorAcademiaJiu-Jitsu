...
public class Professor extends Praticante implements Iprofessor {
    ...
    @Override
    public void criarAula(LocalDateTime dataHoraInicio, LocalDateTime dataHoraFim, String local, ListaAulas listaAulas) {
        Aula aula = new Aula(dataHoraInicio, dataHoraFim, local, this, listaAulas);
